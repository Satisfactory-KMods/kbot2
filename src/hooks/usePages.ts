 ...
 */
export default function usePages<T>( initValue : T[] | ( () => T[] ), maxPerPage = 5, initPage = 1 ) : [ T[], number, number, React.Dispatch<React.SetStateAction<number>>, React.Dispatch<React.SetStateAction<T[]>>, T[] ] {
