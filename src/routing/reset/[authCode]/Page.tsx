...
const Component: FC = () => {
	...
	const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
		...
		if (password !== undefined && passwordAgain !== undefined) {
			...
			setIsLoading(true);
			const Response = await tRPC_Public.resetpassword
				.mutate({
					password,
					token: authCode!
				})
	...
	return (
		<>
			<h1 className='text-center text-xl font-bold leading-tight tracking-tight text-gray-900 text-white md:text-2xl'>Reset your password</h1>
