...
import { Component } from "@routing/error/[ErrorCode]/Index";

const rootRouter = createBrowserRouter( createRoutesFromElements(
	<>
		<Route path="error/:ErrorCode" element={ <Component/> }/>
		...
		<Route path="/guild/:guildId" lazy={ () => import("@guild/Layout") }>
			<Route path="error/:ErrorCode" element={ <Component/> }/>
			<Route path="chatcommand" lazy={ () => import("@guild/chatcommands/Index") }/>
