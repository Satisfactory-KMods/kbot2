	...
	return (
		<div className="p-3 pe-6 flex w-full bg-gray-700 border-y border-gray-600">
			<Link className="flex items-center flex-1" to={ `#` }>
				<img src={ guildData.guildData.iconURL || "/images/invalid.png" } alt={ guildData.guildData.name }
				     className="mr-3 h-6 sm:h-9 rounded-full"/>
				<span
					className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">{ guildData.guildData.name }</span>
			</Link>
