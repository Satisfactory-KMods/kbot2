export default {
    ...
    firstpagebutton: ({ context }) => {return {
        class: [
            'relative',
    ...
    previouspagebutton: ({ context }) => {return {
        class: [
            'relative',
