export default {
    ...
    column: {
        headercell: ({ context, props }) => {return {
            class: [
                'font-bold',
        ...
        bodycell: ({ props, context, state, parent }) => {return {
            class: [
                //Position
        ...
        filtermenubutton: ({ context }) => {return {
            class: [
                'relative',
                // Flex & Alignment
        ...
        headerfilterclearbutton: ({ context }) => {return {
            class: [
                'relative',
